...
5. Встановити oatpp у локальний префікс. Ця команда встановлює скомпільовану бібліотеку oatpp, заголовні файли та конфігурацію пакета CMake у теці `install`, роблячи їх доступними для розробки.
...
6. Встановіть OpenTelemetry C++ в той самий локальний префікс, що й oatpp:
